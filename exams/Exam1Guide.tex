...
\begin{document}
The first exam will cover everything we have discussed so far this semester.  In particular, this means polynomials, field extensions, and the relationship between the two.  Here is a checklist of these topics.
...
\begin{itemize}
  ...
  \begin{itemize}
    \item The Division Algorithm for polynomials (along with long division).
...
\begin{answer}
	\begin{parts}
		\part No, there is no polynomial that would work here because whenever you multiply polynomials together, the degree increases, so there is no way to get down to the degree 0 polynomial 1.
