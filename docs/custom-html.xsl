<!-- This file is part of the book                 --><!--                                               --><!--   Discrete Mathematics: an Open Introduction  --><!--                                               --><!-- Copyright (C) 2015-2018 Oscar Levin           --><!-- See the file COPYING for copying conditions.  --><!-- Parts of this file were adapted from the author guide at https://github.com/rbeezer/mathbook and the analagous file at https://github.com/twjudson/aata --><!-- DMOI customizations for HTML runs --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">

<!-- Assumes current file is in discrete-text/xsl and that the mathbook repository is adjacent -->
<xsl:import pretext-href="pretext-html.xsl" href="c:/users/oscar.levin/appdata/local/programs/python/python39/lib/site-packages/pretext/static/xsl/pretext-html.xsl"/>
...
<xsl:param name="exercise.worksheet.answer" select="'yes'"/>
...
<xsl:template match="project|activity|exploration|investigation" mode="heading-full">
    <h6 class="heading">
        <span class="type">
        ...
        <!--  -->
        <xsl:if test="creator and (self::theorem or self::corollary or self::lemma or self::algorithm or self::proposition or self::claim or self::fact or self::identity or self::axiom or self::conjecture or self::principle or self::heuristic or self::hypothesis or self::assumption)">
            <xsl:text> </xsl:text>
            <span class="creator">
                <xsl:text>(</xsl:text>
...
<!-- Allow solutions when specified: -->
<xsl:template match="solution">
    <xsl:if test="ancestor::*/@solutions = 'yes'">
