...
\addtocontents{toc}{\protect\hypertarget{activity02-QuotientRingExtensions}{}}
%
%
\typeout{************************************************}
\typeout{Worksheet  Quotient Rings that are Extension Fields}
\typeout{************************************************}
%
\newgeometry{left=1in, right=1in, top=1in, bottom=1.25cm}
\begin{worksheet-section-numberless}{Quotient Rings that are Extension Fields}{}{Quotient Rings that are Extension Fields}{}{}{worksheet-1}
\begin{introduction}{}%
\hypertarget{p-1}{}%
We have seen a connection between extension fields and quotient rings.  In particular, \(F[x]/\langle p(x) \rangle \cong F(c)\), where \(c\) is a root of its minimum polynomial \(p(x)\).  The goal of this activity is to see how working in quotient rings help us realize \(E = F(c)\) as a field.%
\par
\hypertarget{p-2}{}%
...
\hypertarget{p-5}{}%
One of the elements in \(E\) is \(1+3\sqrt{2}\).  What element in the quotient ring does this correspond to?%
\end{divisionexercise}%
\begin{divisionexercise}{3}{}{0.3}{exercise-3}%
\hypertarget{p-7}{}%
...
\end{divisionexercise}%
\begin{divisionexercise}{5}{}{0.3}{exercise-5}%
\hypertarget{p-11}{}%
