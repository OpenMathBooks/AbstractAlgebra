...
<!-- <xsl:param name="latex.geometry" select="'papersize={8.5in,11in}, width=6.5in, inner=1in, height=9in, top=1in, ignoreheadfoot'"/> -->
...
<xsl:template name="titlesec-section-style">
    ...
    {0.0em}
    {#1}&#xa;</xsl:text>
    <xsl:text>\titlespacing*{\section}{0pt}{-5em}{1em}&#xa;</xsl:text>
</xsl:template>
